    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        $.each(data.items, function(e, item) {
            ...
            var eventEndDate = item.end.dateTime || item.end.date || '';
          var summary = item.summary || '';
					var description = item.description;
					var location = item.location;
					s ='<div class="eventtitle">' + summary + '</div>';
					s += '<div class="eventdate"> Milloin: ' + formatDate(eventdate, defaults.dateFormat.trim()) + " - " + formatDate(eventEndDate, "ShortTime") + '</div>';
					if(location) {
